    ...
    <div className="flex flex-1 min-h-screen justify-center px-6 py-16">
      <div className="w-full max-w-3xl">
        ...
        <section className="mt-12 scroll-mt-24" id="base-url">
          <h2 className="text-xl font-semibold text-heading">Base URL</h2>
        ...
        <section className="mt-12 scroll-mt-24" id="authentication">
          <h2 className="text-xl font-semibold text-heading">Authentication</h2>
          ...
          <div className="mt-4 overflow-hidden rounded-xl border border-border bg-card">
            <div className="border-b border-border px-4 py-2.5">
              <span className="text-xs text-muted">Header</span>
            </div>
        ...
        <section className="mt-12 scroll-mt-24" id="convert">
          ...
          <div className="mt-4 flex items-center gap-3">
            <span className="rounded bg-emerald-100 dark:bg-emerald-500/20 px-2.5 py-1 text-xs font-bold text-emerald-600 dark:text-emerald-400 ring-1 ring-emerald-300 dark:ring-emerald-500/30">
              POST
            </span>
            <code className="text-sm text-foreground">{convertDocxToPdfEndpoint}</code>
          </div>

          <p className="mt-4 text-sm text-secondary">
            Upload a <code className="rounded bg-surface px-1.5 py-0.5 text-foreground">.docx</code>{" "}
            or <code className="rounded bg-surface px-1.5 py-0.5 text-foreground">.doc</code>{" "}
            ...
            <table className="w-full text-left text-sm">
              <thead>
                <tr className="border-b border-border bg-card">
                  <th className="px-4 py-3 font-medium text-secondary">Parameter</th>
                  <th className="px-4 py-3 font-medium text-secondary">Type</th>
                  <th className="px-4 py-3 font-medium text-secondary">Description</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-border bg-surface">
                <tr>
                  ...
                  <td className="px-4 py-3 text-muted">file</td>
                  <td className="px-4 py-3 text-secondary">
                    The <code className="rounded bg-surface px-1 py-0.5 text-foreground">.doc</code> or{" "}
                    <code className="rounded bg-surface px-1 py-0.5 text-foreground">.docx</code> file to convert.
                    Max 10 MB.
                  </td>
                </tr>
              </tbody>
            ...
            tabs={[
              {
                label: "cURL",
                lang: "bash",
                code: `curl -X POST ${apiBaseUrl}${convertDocxToPdfEndpoint} \\
...
url = "${apiBaseUrl}${convertDocxToPdfEndpoint}"
...
const res = await fetch("${apiBaseUrl}${convertDocxToPdfEndpoint}", {
  method: "POST",
  headers: { Authorization: "Bearer YOUR_API_KEY" },
  body: form,
});
...
public class ConvertDocx {
    public static void main(String[] args) throws Exception {
        ...
        HttpURLConnection conn = (HttpURLConnection)
            new URL("${apiBaseUrl}${convertDocxToPdfEndpoint}").openConnection();
...
int main() {
    ...
    curl_easy_setopt(curl, CURLOPT_URL, "${apiBaseUrl}${convertDocxToPdfEndpoint}");
            ...
            <table className="w-full text-left text-sm">
              <thead>
                <tr className="border-b border-border bg-card">
                  ...
                  <th className="px-4 py-3 font-medium text-secondary">Content-Type</th>
                  <th className="px-4 py-3 font-medium text-secondary">Body</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-border bg-surface">
                <tr>
                  <td className="px-4 py-3">
                    <code className="text-emerald-600 dark:text-emerald-400">200</code>
                  </td>
                  <td className="px-4 py-3 text-muted">application/pdf</td>
                  <td className="px-4 py-3 text-secondary">The converted PDF binary.</td>
                </tr>
                <tr>
                  <td className="px-4 py-3">
                    <code className="text-amber-600 dark:text-amber-400">400</code>
                  </td>
                  <td className="px-4 py-3 text-muted">application/json</td>
                  <td className="px-4 py-3 text-secondary">Invalid file or missing parameter.</td>
                </tr>
                <tr>
                  <td className="px-4 py-3">
                    <code className="text-red-600 dark:text-red-400">401</code>
                  </td>
                  <td className="px-4 py-3 text-muted">application/json</td>
                  <td className="px-4 py-3 text-secondary">Missing or invalid API key.</td>
                </tr>
                <tr>
                  <td className="px-4 py-3">
                    <code className="text-red-600 dark:text-red-400">413</code>
                  </td>
                  <td className="px-4 py-3 text-muted">application/json</td>
                  <td className="px-4 py-3 text-secondary">File exceeds 10 MB limit.</td>
                </tr>
                <tr>
                  <td className="px-4 py-3">
                    <code className="text-red-600 dark:text-red-400">429</code>
                  </td>
                  <td className="px-4 py-3 text-muted">application/json</td>
                  <td className="px-4 py-3 text-secondary">Rate limit exceeded.</td>
                </tr>
              </tbody>
            </table>
          </div>
  ...
  "error": {
    ...
    "message": "The uploaded file is not a valid .doc or .docx document."
        ...
        <section className="mt-12 scroll-mt-24" id="compress-endpoint">
          <h2 className="text-xl font-semibold text-heading">Compress File</h2>
          <div className="mt-4 flex items-center gap-3">
            <span className="rounded bg-emerald-100 dark:bg-emerald-500/20 px-2.5 py-1 text-xs font-bold text-emerald-600 dark:text-emerald-400 ring-1 ring-emerald-300 dark:ring-emerald-500/30">
              POST
            </span>
            <code className="text-sm text-foreground">{apiBaseUrl}/file-compressor/compress</code>
          </div>
          ...
          <div className="mt-3 overflow-x-auto rounded-xl border border-border">
            <table className="w-full text-left text-sm">
              ...
              <tbody className="divide-y divide-border bg-surface">
                ...
                <tr>
                  <td className="px-4 py-3">
                    <code className="text-foreground">file_type</code>
                  </td>
                  <td className="px-4 py-3 text-muted">string</td>
                  <td className="px-4 py-3 text-secondary">
                    The type of file being compressed: <code className="rounded bg-surface px-1 py-0.5 text-foreground">image</code>, <code className="rounded bg-surface px-1 py-0.5 text-foreground">pdf</code>, or <code className="rounded bg-surface px-1 py-0.5 text-foreground">docx</code>.
                  </td>
                </tr>
              </tbody>
            </table>
...
int main() {
            ...
            <table className="w-full text-left text-sm">
              ...
              <tbody className="divide-y divide-border bg-surface">
                <tr>
                  ...
                  <td className="px-4 py-3 text-muted">application/octet-stream</td>
                  <td className="px-4 py-3 text-secondary">The compressed file binary.</td>
                </tr>
                <tr>
                  <td className="px-4 py-3">
                    <code className="text-amber-600 dark:text-amber-400">400</code>
                  ...
                  <td className="px-4 py-3 text-muted">application/json</td>
                  <td className="px-4 py-3 text-secondary">Invalid file type or missing parameter.</td>
                </tr>
                <tr>
                  <td className="px-4 py-3">
                    <code className="text-red-600 dark:text-red-400">401</code>
  ...
  "error": {
    ...
    "message": "The specified file_type is not supported. Use 'image', 'pdf', or 'docx'."
        ...
        <section className="mt-12 scroll-mt-24" id="quick-start">
          <h2 className="text-xl font-semibold text-heading">Quick Start Guide</h2>
          <p className="mt-3 text-sm text-secondary">
          ...
          <ol className="mt-5 list-decimal list-inside space-y-4 text-sm text-secondary">
            <li>
              <span className="font-medium text-foreground">Create an account</span> —{" "}
              Sign up at{" "}
              <a href="/signin" className="text-emerald-600 dark:text-emerald-400 underline hover:text-emerald-700 dark:hover:text-emerald-300">
                ilovedox.com/signin
              </a>{" "}
              to get access to your developer dashboard.
            </li>
            <li>
              <span className="font-medium text-foreground">Generate an API key</span> —{" "}
              Navigate to the{" "}
              <a href="/api-keys" className="text-emerald-600 dark:text-emerald-400 underline hover:text-emerald-700 dark:hover:text-emerald-300">
                API Keys
              </a>{" "}
              page and create a new key. Store it securely — treat it like a password.
            </li>
            <li>
              <span className="font-medium text-foreground">Install your preferred SDK</span> —{" "}
              Use <code className="rounded bg-surface px-1.5 py-0.5 text-foreground">npm install ilovedox</code> for
              Node.js or <code className="rounded bg-surface px-1.5 py-0.5 text-foreground">pip install ilovedox</code> for
              Python — or call the REST API directly with cURL, Axios, Fetch, or any HTTP client.
            </li>
            <li>
              <span className="font-medium text-foreground">Make your first request</span> —{" "}
              Send a <code className="rounded bg-surface px-1.5 py-0.5 text-foreground">POST</code> request with
              your <code className="rounded bg-surface px-1.5 py-0.5 text-foreground">.docx</code> file to the{" "}
              <code className="rounded bg-surface px-1.5 py-0.5 text-foreground">${convertDocxToPdfEndpoint}</code> endpoint.
            </li>
            <li>
              <span className="font-medium text-foreground">Receive your PDF</span> —{" "}
              The API returns the converted PDF binary with a{" "}
              <code className="rounded bg-surface px-1.5 py-0.5 text-foreground">200 OK</code> status.
        ...
        <section className="mt-12 scroll-mt-24" id="error-handling">
          <h2 className="text-xl font-semibold text-heading">Error Handling Guide</h2>
          <p className="mt-3 text-sm text-secondary">
          ...
          <div className="mt-3 overflow-x-auto rounded-xl border border-border">
            <table className="w-full text-left text-sm">
              <thead>
                <tr className="border-b border-border bg-card">
                  <th className="px-4 py-3 font-medium text-secondary">Code</th>
                  <th className="px-4 py-3 font-medium text-secondary">Error</th>
                  <th className="px-4 py-3 font-medium text-secondary">Cause & Resolution</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-border bg-surface">
                <tr>
                  <td className="px-4 py-3"><code className="text-amber-600 dark:text-amber-400">400</code></td>
                  <td className="px-4 py-3 text-foreground">INVALID_FILE</td>
                  <td className="px-4 py-3 text-secondary">
                    The uploaded file is not a valid .doc/.docx. Verify MIME type and file extension before uploading.
                  </td>
                </tr>
                <tr>
                  <td className="px-4 py-3"><code className="text-red-600 dark:text-red-400">401</code></td>
                  <td className="px-4 py-3 text-foreground">UNAUTHORIZED</td>
                  <td className="px-4 py-3 text-secondary">
                    API key is missing or invalid. Check the <code className="rounded bg-surface px-1 py-0.5 text-foreground">Authorization</code> header format.
                  </td>
                </tr>
                <tr>
                  <td className="px-4 py-3"><code className="text-red-600 dark:text-red-400">413</code></td>
                  <td className="px-4 py-3 text-foreground">PAYLOAD_TOO_LARGE</td>
                  <td className="px-4 py-3 text-secondary">
                    File exceeds the maximum size for your plan. Compress the DOCX or upgrade to a higher tier.
                  </td>
                </tr>
                <tr>
                  <td className="px-4 py-3"><code className="text-red-600 dark:text-red-400">429</code></td>
                  <td className="px-4 py-3 text-foreground">RATE_LIMITED</td>
                  <td className="px-4 py-3 text-secondary">
                    Too many requests. Implement exponential backoff and respect the{" "}
                    <code className="rounded bg-surface px-1 py-0.5 text-foreground">Retry-After</code> header.
                  </td>
                </tr>
                <tr>
                  <td className="px-4 py-3"><code className="text-red-600 dark:text-red-400">500</code></td>
                  <td className="px-4 py-3 text-foreground">INTERNAL_ERROR</td>
                  <td className="px-4 py-3 text-secondary">
          ...
          <p className="mt-3 text-sm text-secondary">
            For transient errors (5xx, 429), use <strong className="text-foreground">exponential backoff with jitter</strong>.
        ...
        <section className="mt-12 scroll-mt-24" id="rate-limits">
          ...
          <div className="mt-4 overflow-x-auto rounded-xl border border-border">
            <table className="w-full text-left text-sm">
              <thead>
                <tr className="border-b border-border bg-card">
                  <th className="px-4 py-3 font-medium text-secondary">Plan</th>
                  <th className="px-4 py-3 font-medium text-secondary">Conversions / month</th>
                  <th className="px-4 py-3 font-medium text-secondary">Max file size</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-border bg-surface">
                <tr>
          ...
          <p className="mt-3 text-sm text-muted">
            Rate limit headers{" "}
            <code className="rounded bg-surface px-1.5 py-0.5 text-secondary">X-RateLimit-Remaining</code>{" "}
            and{" "}
            <code className="rounded bg-surface px-1.5 py-0.5 text-secondary">X-RateLimit-Reset</code>{" "}
        ...
        <section className="mt-12 scroll-mt-24" id="best-practices">
          <h2 className="text-xl font-semibold text-heading">Best Practices</h2>
          <p className="mt-3 text-sm text-secondary">
          ...
          <div className="mt-6 space-y-6">
            <div className="rounded-lg border border-border bg-card/50 p-5">
              <h3 className="text-sm font-semibold text-emerald-600 dark:text-emerald-400">Validate Files Client-Side</h3>
              <p className="mt-2 text-sm text-secondary">
                Check MIME types (<code className="rounded bg-surface px-1 py-0.5 text-foreground">application/vnd.openxmlformats-officedocument.wordprocessingml.document</code>)
                and file size before uploading. This reduces unnecessary API calls and improves UX with instant feedback.
              </p>
            </div>

            <div className="rounded-lg border border-border bg-card/50 p-5">
              <h3 className="text-sm font-semibold text-emerald-600 dark:text-emerald-400">Use Streaming for Large Files</h3>
              <p className="mt-2 text-sm text-secondary">
            ...
            <div className="rounded-lg border border-border bg-card/50 p-5">
              <h3 className="text-sm font-semibold text-emerald-600 dark:text-emerald-400">Secure Your API Keys</h3>
              <p className="mt-2 text-sm text-secondary">
            ...
            <div className="rounded-lg border border-border bg-card/50 p-5">
              <h3 className="text-sm font-semibold text-emerald-600 dark:text-emerald-400">Implement Idempotency</h3>
              <p className="mt-2 text-sm text-secondary">
            ...
            <div className="rounded-lg border border-border bg-card/50 p-5">
              <h3 className="text-sm font-semibold text-emerald-600 dark:text-emerald-400">Cache Converted PDFs</h3>
              <p className="mt-2 text-sm text-secondary">
            ...
            <div className="rounded-lg border border-border bg-card/50 p-5">
              <h3 className="text-sm font-semibold text-emerald-600 dark:text-emerald-400">Monitor & Observe</h3>
              <p className="mt-2 text-sm text-secondary">
        ...
        <section className="mt-12 scroll-mt-24" id="webhooks">
          <h2 className="text-xl font-semibold text-heading">Webhooks & Asynchronous Processing</h2>
          <p className="mt-3 text-sm text-secondary">
          ...
          <ol className="mt-3 list-decimal list-inside space-y-2 text-sm text-secondary">
            <li>Submit a conversion request with a <code className="rounded bg-surface px-1.5 py-0.5 text-foreground">webhook_url</code> parameter.</li>
            <li>The API returns a <code className="rounded bg-surface px-1.5 py-0.5 text-foreground">202 Accepted</code> response with a job ID.</li>
            <li>When conversion completes, we send a <code className="rounded bg-surface px-1.5 py-0.5 text-foreground">POST</code> to your webhook URL with the result.</li>
  ...
  "created_at": "2026-05-03T10:30:00Z"
          ...
          <p className="mt-3 text-sm text-muted">
            ...
            <code className="rounded bg-surface px-1.5 py-0.5 text-secondary">X-Webhook-Signature</code>{" "}
        ...
        <section className="mt-12 scroll-mt-24" id="use-cases">
          <h2 className="text-xl font-semibold text-heading">Common Use Cases & Workflows</h2>
          <p className="mt-3 text-sm text-secondary">
        ...
        <section className="mt-12 scroll-mt-24" id="cicd">
          <h2 className="text-xl font-semibold text-heading">CI/CD & DevOps Integration</h2>
          <p className="mt-3 text-sm text-secondary">
          ...
          <div className="mt-3 overflow-hidden rounded-xl border border-border bg-card">
            <div className="border-b border-border px-4 py-2.5">
              <span className="text-xs text-muted">yaml</span>
            </div>
            <pre className="overflow-x-auto p-5 text-sm leading-relaxed text-foreground">
              <code>{`- name: Convert docs to PDF
  run: |
    for file in docs/*.docx; do
      curl -X POST ${apiBaseUrl}${convertDocxToPdfEndpoint} \\
        ...
        <section className="mt-12 scroll-mt-24" id="tutorials">
          <h2 className="text-xl font-semibold text-heading">Tutorials & Learning Resources</h2>
          <p className="mt-3 text-sm text-secondary">
          ...
          <div className="mt-4 space-y-3">
            {[
              ...
              <a
                ...
                className="group block rounded-lg border border-border bg-card/50 p-4 transition-colors hover:border-border hover:bg-card"
              >
                <div className="flex items-start gap-3">
                  <span className="mt-0.5 flex h-8 w-8 shrink-0 items-center justify-center rounded-md bg-red-100 dark:bg-red-500/20 text-red-600 dark:text-red-400">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="h-4 w-4">
                      <path d="M8 5v14l11-7z" />
                    </svg>
                  </span>
                  <div>
                    <h4 className="text-sm font-medium text-foreground group-hover:text-heading">
                      {video.title}
                    </h4>
                    <p className="mt-1 text-xs text-muted">{video.desc}</p>
                  </div>
                </div>
              </a>
            ))}
              ...
              >
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-xs text-muted">{guide.desc}</p>
                  </div>
                </div>
              </a>
            ))}
        ...
        <section className="mt-12 scroll-mt-24" id="faq">
          <h2 className="text-xl font-semibold text-heading">Frequently Asked Questions</h2>
