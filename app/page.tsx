...
export default function Home() {
      ...
      <section className="flex flex-col items-center px-6 pt-20 pb-16 text-center">
        ...
        <div className="mt-8 flex flex-wrap items-center justify-center gap-4">
          <Link
            href="/docs"
            role="button"
            className="rounded-xl px-6 py-3 text-sm font-semibold transition-all focus:outline-none"
            style={{
          ...
          <Link
            ...
            role="button"
            className="rounded-xl border border-white/8 px-6 py-3 text-sm font-semibold text-zinc-400 transition-colors hover:border-white/15 hover:text-zinc-200 focus:outline-none"
          >
            Try it Free Online
          </Link>
        </div>
  ...
  -o output.pdf`}</code>
      ...
      <section className="mx-auto w-full max-w-4xl px-6 py-16">
        ...
        <div className="mt-10 grid gap-8 sm:grid-cols-3">
          <div className="text-center">
            <div className="mx-auto flex h-12 w-12 items-center justify-center rounded-full bg-accent/10 text-lg font-bold text-accent ring-1 ring-indigo-500/20">
              1
            </div>
      ...
      {/* Stats / Social Proof */}
      <section className="border-y border-white/8 bg-white/[0.015] px-6 py-16">
        <div className="mx-auto grid max-w-4xl gap-8 text-center sm:grid-cols-4">
          ...
          <div>
            <p className="text-3xl font-bold text-accent">&lt;1s</p>
            <p className="mt-1 text-sm text-zinc-400">Avg. Conversion Time</p>
          </div>
          <div>
            <p className="text-3xl font-bold text-accent">256-bit</p>
